...
@section('title') Bank Statistics @endsection
@section('content')
    <!-- begin: PicTime-->
        ...
        <div class="col-xl-12">
            ...
            <div class="kt-portlet kt-portlet--tabs kt-portlet--height-fluid">
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            Bảng thống kê doanh thu của ngân hàng
                        </h3>
                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:75%">Tên ngân hàng</td>
                                            <td style="width:15%" class="kt-align-right">Doanh Thu</td>
                                        </tr>
                                        </thead>
                                        <tbody>

                                            @foreach  ($data->revenue_bank as $key => $value)
                                                <tr>
                                                    <td>
                                                        {{$key}}
                                                    </td>
                                                    <td>
                                                        <span class="kt-widget11__title">{{$value->bank_name}}</span>
                                                    </td>
                                                    <td class="kt-align-right kt-font-brand  kt-font-bold">{{$value->amount}}</td>
                                                </tr>
                                            @endforeach 
