...
final class MimeTypes implements MimeTypesInterface
{
    ...
    private static $map = [
        ...
        'application/x-raw-disk-image' => ['raw-disk-image', 'imgs'],
        'application/x-raw-disk-image-xz-compressed' => ['raw-disk-image.xz', 'imgs.xz'],
    ...
    private static $reverseMap = [
        ...
        'imgs' => ['application/x-raw-disk-image'],
        'imgs.xz' => ['application/x-raw-disk-image-xz-compressed'],
