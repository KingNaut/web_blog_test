...
class EmailTest extends TestCase
{
    ...
    public function testGenerateBody()
    {
        ...
        $e = new Email();
        $e->html($content = 'html content <imgs src="test.gif">');
        $e->text('text content');
        $e->attach($file);
        $e->attach($image, 'test.gif');
        ...
        $e = new Email();
        $e->html($content = 'html content <imgs src="cid:test.gif">');
        $e->text('text content');
        $e->attach($file);
        $e->attach($image, 'test.gif');
        $fullhtml = new TextPart($content, 'utf-8', 'html');
        ...
        $content = 'html content <imgs src="cid:test.gif">';
        ...
        $this->assertStringMatchesFormat('html content <imgs src=3D"cid:%s@symfony">', $parts[0]->bodyToString());
    }
